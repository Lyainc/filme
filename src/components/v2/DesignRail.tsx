    ...
    >
      <div className="overflow-hidden" inert={!open || undefined}>
        ...
        {/* 고정 슬롯(#563) — 항목마다 콘텐츠 높이가 89~205px로 갈려서(400×675 실측) 탭을 옮길
            ...
            대가는 세로 스크롤 하나다. 값: 214px = 가장 높은 항목(후보정 최악, #565의 py-1.5 포함)
            이라 이만큼 세로가 있는 화면에선 아무 항목도 안 스크롤되고, 17.5svh = 400×675에서
            118px이라 6항목 중 4개(무드·크기·투명도·커스텀)가 그대로 들어간다. 항목 콘텐츠를
            키우면 이 상한도 같이 올릴 것 — 안 올리면 큰 화면에서만 조용히 스크롤이 생긴다.
            dvh가 아니라 svh인 이유는
        ...
        <div
          ...
          role="region"
          aria-label={eyebrow}
          className="h-[min(214px,17.5svh)] overflow-y-auto py-3"
        >
