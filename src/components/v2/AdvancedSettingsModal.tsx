    ...
    <div className="fixed inset-0 z-[55]">
      ...
      >
        <div className="shrink-0 px-4 pt-3">
          <div className={CARD}>
            <div className="flex h-touch items-center justify-between gap-2 px-2.5">
              ...
              <button
                ...
                aria-label="닫기"
                data-touch="44"
                className="-mr-1.5 flex h-touch w-touch shrink-0 items-center justify-center rounded-lg text-fg transition-colors hover:bg-white/5"
              >
                <svg {...TB_ICON}>
              ...
              {TOOLBAR_MODES.map((m) => {
                ...
                return (
                  <button
                    ...
                    className={`flex h-touch w-full items-center gap-2.5 rounded-[9px] px-2.5 text-caption font-semibold text-fg ${
            ...
            {prefs.place === 'movable' && (
              <div className="mt-1 flex gap-1 border-t border-line pt-1.5">
                <button
                  ...
                  title="왼쪽 가장자리로 이동"
                  className="flex h-touch flex-1 items-center justify-center rounded-[9px] text-fg-muted transition-colors hover:bg-white/5 hover:text-fg"
                >
                  <svg {...TB_ICON}>
                    <path d="M3 19V5" />
