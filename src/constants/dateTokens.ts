...
// 날짜 표기 토큰·정밀도(#141) — 인라인 폼(MovieInfoForm)과 필드 편집 본문(FieldEditorBody의
// DateSheet)이 공유하는 단일 소스. 배열을 복붙하면 한쪽만 바뀌며 drift가 생기므로(#242 계열) 여기서만 정의한다.
// DateSheet의 표기 칩 sample은 관람일 예시 문자열이라 별개 — 값·순서만 같다.
