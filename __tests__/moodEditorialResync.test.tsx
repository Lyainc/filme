...
// Editorial 델타(3열→4열 대규모 재구조): 포스터 640(#440 0.667 리사이즈, 구 516) · 골드포일 세로 스트립 42(신규 장식) · 메인 flex · 스텁 213(#572로 224에서 -5%).
...
describe('MoodEditorial 마스터 resync (#281)', () => {
  test('4열 구조 — 포스터 640(#440) · 골드포일 42 · 메인 flex · 스텁 213(#572)', () => {
    const html = markup();
    ...
    expect(html).toContain('flex:0 0 213px'); // 스텁(#572: 224 -5%)
  });
